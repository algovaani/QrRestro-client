...
const syncUserFromApi = (prev, u) => ({
  ...
  planFeatureKeys: Array.isArray(u.planFeatureKeys) ? u.planFeatureKeys : [],
  planFeatures: Array.isArray(u.planFeatures) ? u.planFeatures : [],
  extraFeatureKeys: Array.isArray(u.extraFeatureKeys) ? u.extraFeatureKeys : [],
